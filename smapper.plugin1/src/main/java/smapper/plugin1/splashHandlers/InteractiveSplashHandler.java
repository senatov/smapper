...
public class InteractiveSplashHandler extends AbstractSplashHandler {
	...
	private void createUIButtonCancel() {
		...
		final GridData data = new GridData(SWT.NONE, SWT.NONE, false, false);
	...
	private void createUILabelBlank() {
		...
		final Label label = new Label(fCompositeLogin, SWT.NONE);
	...
	private void createUICompositeBlank() {
		...
		final Composite spanner = new Composite(fCompositeLogin, SWT.NONE);
